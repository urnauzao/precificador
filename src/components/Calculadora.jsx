...
const valoresCamposCalculadora = {
    ...
    'comissao': {
        ...
        'sh_d': { id: 'sh_d', 'tipo': 'Padrão', 'taxa': '12', 'precovenda': '0' },
        'b2_d': { id: 'b2_d', 'tipo': 'Padrão', 'taxa': '16', 'precovenda': '0' },
        'ma_d': { id: 'ma_d', 'tipo': 'Padrão', 'taxa': '16', 'precovenda': '0' },
        'az_d': { id: 'az_d', 'tipo': 'Padrão', 'taxa': '16', 'precovenda': '0' },
        'vi_d': { id: 'vi_d', 'tipo': 'Padrão', 'taxa': '16', 'precovenda': '0' }
    },
    // 'mlucro':"10",
    // 'precovenda':"0",
    'custofrete': "0"
...
const marketplacesOptions = [
    ...
    },
    {
        ...
        taxa_venda: {
            custom: false,
            modo_ofertas: {
                b2_d: { id: 'b2_d', tipo: 'Padrão', taxa: '16' }
            },
            opcoes: [
                { taxa: '0', texto: "Sem custos" },
                { taxa: '9', texto: "9%" },
        ...
        forma_envio: {
            ...
            envio_gratis_personalizado: true,
            custo_envio_personalizado: 0,
            custo_regional_personalizado: true,
            custo_regional: {
                norte: 0,
                sudest: 0,
                nordeste: 0,
    ...
    },
    {
        ...
        taxa_venda: {
            custom: false,
            modo_ofertas: {
                ma_d: { id: 'ma_d', tipo: 'Padrão', taxa: '16' },
            },
            opcoes: [
                { taxa: '0', texto: "Sem custos" },
                { taxa: '9', texto: "9%" },
    ...
    },
    {
        ...
        taxa_venda: {
            custom: false,
            modo_ofertas: {
                az_d: { id: 'az_d', tipo: 'Padrão', taxa: '16' },
            },
            opcoes: [
                { taxa: '0', texto: "Sem custos" },
                { taxa: '11', texto: "11%" },
    ...
    },
    {
        ...
        taxa_venda: {
            custom: false,
            modo_ofertas: {
                vi_d: { id: 'vi_d', tipo: 'Padrão', taxa: '16' },
            },
            opcoes: [
                { taxa: '0', texto: "Sem custos" },
                { taxa: '11', texto: "11%" },
...
export const Calculadora = () => {
    ...
    /** @todo implementar cores para caso de lucro ou prejuízo */
    // https://primefaces.org/primereact/showcase/#/datatable/style
